<x-app-layout>
    <x-slot name="header">
        <div class="topbar-title">{{ __('app.add_user') }}</div>
        <div class="topbar-subtitle">{{ __('app.create_user_subtitle') }}</div>
    </x-slot>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <select id="role" name="role"
                                    ...
                                    <option value="admin">{{ __('app.admins') }}</option>
                                    <option value="professor">{{ __('app.professors') }}</option>
                                    <option value="student">{{ __('app.students') }}</option>
                                </select>

<x-app-layout>
    <x-slot name="header">
        <div class="topbar-title">{{ __('app.edit_room') }}</div>
        <div class="topbar-subtitle">{{ __('app.edit_room_sub', ['name' => $room->name]) }}</div>
    </x-slot>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <select id="type" name="type"
                                    ...
                                    <option value="Cours" {{ $room->type === 'Cours' ? 'selected' : '' }}>{{ __('app.room_type_course') }}</option>
                                    <option value="Labo" {{ $room->type === 'Labo' ? 'selected' : '' }}>{{ __('app.room_type_lab') }}</option>
                                </select>

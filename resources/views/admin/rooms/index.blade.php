<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <div>
                <div class="topbar-title">Gestion des Salles</div>
                <div class="topbar-subtitle">Gérez les salles de cours, labos et amphithéâtres</div>
            </div>
    ...
    <div class="py-6 animate-fade-in">
        ...
        <div class="dark-card rounded-3xl overflow-hidden border border-white/5">
            ...
            <div class="p-6">
                @if($rooms->isEmpty())
                    <p class="text-gray-400 italic text-center py-6">Aucune salle enregistrée.</p>
                @else
                    ...
                    <table class="min-w-full divide-y divide-white/5">
                        ...
                        <tbody class="text-sm divide-y divide-white/5 text-gray-300">
                            ...
                            <tr class="hover:bg-white/[0.02] transition-colors">
                                ...
                                <td class="py-4">
                                    <span class="px-2.5 py-1 rounded-full text-xs font-bold bg-[#3b82f6]/10 border border-[#3b82f6]/20 text-[#3b82f6]">{{ $room->capacity }} places</span>
                                </td>
                                <td class="py-4">
                                ...
                                <td class="py-4 text-right space-x-2">
                                    <a href="{{ route('admin.rooms.edit', $room) }}" class="inline-flex items-center px-3 py-1 bg-[#8b5cf6]/10 hover:bg-[#8b5cf6]/20 border border-[#8b5cf6]/20 text-[#8b5cf6] text-xs font-bold rounded-xl transition">Modifier</a>

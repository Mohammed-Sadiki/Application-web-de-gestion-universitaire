<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <div>
                <div class="topbar-title">Mon Cahier de Textes</div>
                <div class="topbar-subtitle">Consultez et rédigez les comptes-rendus de vos séances de cours</div>
            </div>
        ...
        <div class="dark-card rounded-3xl overflow-hidden border border-white/5">
            <div class="p-6 bg-[#17192a]/30 border-b border-white/5">
                <h3 class="text-lg font-bold text-white flex items-center gap-2">
                    ...
                    Liste des séances consignées
                </h3>
            </div>
            <div class="p-6">
                @if($logs->isEmpty())
                    <p class="text-gray-400 italic text-center py-6">Aucun enregistrement dans le cahier de textes pour le moment.</p>
                @else
                        ...
                        <table class="min-w-full divide-y divide-white/5">
                            <thead>
                                <tr class="text-left text-xs font-bold text-gray-400 uppercase tracking-wider">
                                    ...
                                    <th class="pb-3 text-left">Objectif & Contenu</th>
                                </tr>
                            </thead>

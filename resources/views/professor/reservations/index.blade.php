<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center w-full">
            <div>
                <div class="topbar-title">Mes Réservations de Salles</div>
                <div class="topbar-subtitle">Consultez vos réservations de salles de cours pour vos examens ou travaux pratiques</div>
            </div>
        ...
        <div class="dark-card rounded-3xl overflow-hidden border border-white/5">
            ...
            <div class="p-6">
                @if($reservations->isEmpty())
                    <p class="text-gray-400 italic text-center py-6">Vous n'avez pas de réservations en cours.</p>
                @else
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-white/5">
                            <thead>
                                <tr class="text-left text-xs font-bold text-gray-400 uppercase tracking-wider">
                                    <th class="pb-3 text-left">Salle</th>
                                    <th class="pb-3 text-left">Capacité</th>
                                    <th class="pb-3 text-left">Date</th>
                                    <th class="pb-3 text-left">Créneau</th>
                                    <th class="pb-3 text-left">Motif / Description</th>
                                </tr>
                            </thead>
